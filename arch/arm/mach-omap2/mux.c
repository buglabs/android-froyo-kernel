...
///  This should be renamed from GPIO55 to GPT9 or PWM or something
///  must be changed in mux.h/boardfile too..
...
/* Pin muxing for DVI and VGA video plug in module*/
MUX_CFG_34XX("DSS_DATA_18", 0x100,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_DATA_19", 0x102,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_DATA_20", 0x104,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_DATA_21", 0x106,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_DATA_22", 0x108,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_DATA_23", 0x10a,
		OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("GPIO_10", 0xa1a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)

/* Pin muxing for LCD plug-in module*/
MUX_CFG_34XX("LCD_MCSPI3_CLK", 0x100,
		OMAP34XX_MUX_MODE2 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("LCD_MCSPI3_SIMO", 0x102,
		OMAP34XX_MUX_MODE2 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("LCD_SHUTDOWN", 0x104,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("LCD_MCSPI3_CS", 0x106,
		OMAP34XX_MUX_MODE2 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("ACC_RESET", 0x108,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("LCD_TP_RESET", 0x10a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("ACC_INT", 0xa1a,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)

/* Pin muxing for LCD slot 'safe mode' state*/
MUX_CFG_34XX("DSS_D18", 0x100,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_D19", 0x102,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_D20", 0x104,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_D21", 0x106,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT)
MUX_CFG_34XX("DSS_D22", 0x108,
		OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_OUTPUT)
